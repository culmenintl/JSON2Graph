...
import { Theme, Navbar, Button, Form, Input, Divider } from "react-daisyui"
...
export const GraphNavbar: FC<{}> = () => {
    ...
    const edgesCount = useStore()
        ...
        ?.getEdges()
        .length.toLocaleString()
    // const sampledRows = useTrackedStore().graph.rows()
                ...
                <Navbar className="shadow-xl rounded-box">
                    <div className="flex flex-col w-full">
                        ...
                        <div className="flex flex-1 flex-row w-full gap-2 text-sm text-slate-400 justify-center py-3">
                            ...
                            <Divider horizontal />
                            <div className="">
                                {sampledRows.toLocaleString()}/
                                {formattedSampleRows} rows
                            </div>
                        </div>
